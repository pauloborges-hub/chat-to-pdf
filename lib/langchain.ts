...
export async function generateEmbeddingsInPineconeVectorStore(docId: string) {
   ...
   if (namespaceAlreadyExists) {
      ...
      // If the namespace does not exist, download the PDF from the firestore via the stored Download URL and generate
      // the embeddings to store them in the Pinecone vector store
