        ...
        <div className="flex flex-col justify-center items-center mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            <h2 className="text-base font-semibold leading-7 text-orange-600">
              Your Interactive Document Assistant
            </h2>
            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-6xl">Bring Your PDFs to Life with Smart Conversations</p>

            <p className="mt-6 text-lg leading-8 text-gray-600">
              Meet{" "}
              <span className="font-bold text-orange-600">Chat with PDF.</span>
              <br />
              <br /> Upload your document, and our chatbot will answer questions, summarize content, and answer
              all your Qs. Ideal for everyone, <span className="text-orange-600">Chat with PDF</span>{" "}
