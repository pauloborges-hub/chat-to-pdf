      ...
      <div>
         <div className="py-24 sm:py-32">
            ...
            <p className="mx-auto mt-6 max-w-2xl px-10 text-center text-lg leading-8 text-gray-600">
               Choose an affordable plan that is packed with the best features for interacting with yout PDFs,
               enhancing productivity, and streamlining your workflow.
            </p>

            <div className="max-w-md mx-auto mt-10 grid grid-cols-1 md:grid-cols-2 md:max-w-2xl gap-8 lg:max-2-4xl">
               {/* Free */}
               ...
               <div className="ring-2 ring-orange-600 rounded-3xl p-8">
                  ...
                  <Button className="
                     bg-orange-600 w-full text-white shadow-sm 
                     hover:bg-orange-500 mt-6 block rounded-md px-3 py-2 
